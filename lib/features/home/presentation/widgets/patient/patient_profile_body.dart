    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'patient@example.com', // Placeholder for email
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Gap(15.h),
          _buildInfoCard([
            _buildInfoRow('العمر', '25 عام'),
            _buildInfoRow('المدينة', 'القاهرة'),
            _buildInfoRow('الجنس', 'ذكر'),
            _buildInfoRow('رقم الهاتف', '0123456789'),
          ]),
        ],
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSettingsTile(Icons.notifications, 'الإشعارات', () {}),
          _buildSettingsTile(Icons.language, 'اللغة', () {}),
          _buildSettingsTile(Icons.help_outline, 'المساعدة', () {}),
          const Divider(),
