...
class _DoctorDetailsScreenState extends State<DoctorDetailsScreen> {
  ...
  Future<void> _fetchUserData() async {
    if (user != null) {
      final doc = await FirebaseFirestore.instance.collection('doctor').doc(user!.uid).get();
      if (doc.exists) {
        setState(() {
          userData = doc.data();
          isLoading = false;
  ...
  Future<void> updateData(String key, String value) async {
    ...
    try {
      await FirebaseFirestore.instance.collection('doctor').doc(user!.uid).update({key: value});
      if (key == "name") {
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    keyboardType: valueKey[index] == 'phone1' || valueKey[index].contains('Hour')
                        ? TextInputType.number
                        : TextInputType.text,
                    maxLines: valueKey[index] == 'bio' ? 3 : 1,
